...
2. **A11Y-H5** — Toast aria-live
3. **A11Y-H6** — Status badge contrast
4. **DATA-M1** — تبدیل LD↔CS بدون rollback
5. **DATA-M2** — deleteCustomer روی مشتری ناموجود کرش می‌کنه
