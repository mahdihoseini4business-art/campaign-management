...
import {
  ...
  processDueSmsSchedulesManually, sendTodaySettlementSmsManual
} from './sms-ui.js'
import {
...
async function openSettingsModal(sectionId) {
  await openSettingsModalBase(sectionId)
...
const app = {
  ...
  onCustomerPlatformIdInput,
  selectCustomerPhoneSuggest,
  onCustomerPhoneSuggestBlur,
  onCustomerPhoneKeydown,
  ...
  clearNextFollowup,
  addQuickNote,
  onDetailQuickProductPick,
  removeDetailQuickProduct,
  onFollowupProductPick,
  removeFollowupProduct,
  ...
  openMatrixImportModal,
  closeMatrixImportModal,
  doMatrixImport,
  dryRunMatrixImport,
  setMatrixImportMapping,
  setMatrixProductValueMap,
  ...
  makeGroupManager,
  saveSettingsGroupAccess,
  onGroupSettingsAccessToggle,
  addDestinationBank,
  ...
  addInPersonSession,
  startInPersonSessionEdit,
  cancelInPersonSessionEdit,
  saveInPersonSessionEdit,
  removeInPersonSession,
  assignUnassignedInPersonSale,
  unassignInPersonSale,
  filterInPersonSessionsList,
  filterUnassignedInPersonSales,
  filterAssignedInPersonSales,
  onInPersonAssignCourseFilterFromAdd,
  renderSalesTargetsSettings,
  onSalesTargetMetricChange,
  onSalesTargetAllocationChange,
  onSalesTargetDeadlineChange,
  onDeadlineUrgencyFieldChange,
  addSalesTargetFormStage,
  removeSalesTargetFormStage,
  onSalesTargetFormStageChange,
  ...
  openFollowupBulkSms,
  openFollowupBulkSmsForCurrentFilter,
  ...
  removeCustomerCode,
  editCustomerCode,
  cancelCustomerCodeEdit,
  saveCustomerCodeEdit,
  saveCustomerCodeExpiryMonthsFromUi,
  toggleDashConversionAmountInRange,
  syncDashConversionAmountInRangeUi,
  toggleCcSaleFilterKind,
  toggleCcAdvisorDropdown,
  toggleCcProductDropdown,
  toggleCcAdvisorPhone,
  toggleCcAdvisorGroup,
  toggleCcProductName,
  clearCcProductFilter,
  onCcProductFilterSearch,
  onCustomerCodeDragStart,
  onCustomerCodeDragOver,
  onCustomerCodeDrop,
  toggleProfileMenu,
  switchTab,
  sortCustomers,
  ...
  sortRefundsRejected,
  sortRefundsArchived,
  showMoreRefundColumn,
  showMoreRefundsRejected,
  showMoreRefundsArchived,
  sortDashOverdue,
  sortDashSoon,
  sortDashTransfer,
  showMoreDashFollowups,
  toggleDashSection,
  clearDashFilter,
  applyDashFilter,
  ...
  onDashTargetsScopeChange,
  onDashInPersonSessionChange,
  sortDashInPersonHeader,
  exportDashInPersonSession,
  onDashConversionCodeChange,
  exportDashConversionCodeCustomers,
  ...
  confirmShipment,
  confirmShipmentAndPrint,
  toggleShipmentSelect,
  toggleSelectAllShipments,
  printShipmentLabel,
  printSelectedShipmentLabels,
  copyToClipboard,
  toggleSelectAll,
  toggleRowSelect,
  executeBulkAction,
...
async function init() {
  ...
  try {
    const purged = await purgeExpiredCustomerCodes()
    if (purged?.removed > 0) console.log(`Purged ${purged.removed} expired customer codes`)
  } catch (e) {
    console.error('expired customer codes purge error:', e)
  }

  try {
    const synced = await syncCustomerCodesFromProfiles()
    if (synced?.added > 0) console.log(`Synced ${synced.added} customer codes from profiles into catalog`)
  } catch (e) {
    console.error('customer codes catalog sync error:', e)
  }
